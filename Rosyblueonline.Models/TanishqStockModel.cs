...
{
   public class TanishqStockModel
    {
    ...
    public class BuildSearchCriterias
    {
        public string  SearchCriteriaFinal {get;set;}
    }


    public class TanishqPlaceOrder
    {
    ...
    public class RemoveFromCartInventory
    { 
