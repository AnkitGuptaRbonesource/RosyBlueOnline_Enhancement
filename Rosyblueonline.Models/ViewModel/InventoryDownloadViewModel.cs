...
{
    public class InventoryDownloadViewModel
    {
    ...
    public class InventoryDownloadMemoViewModel
    {
        public string Stock { get; set; }
        public string Shape { get; set; }
        public string Weight { get; set; }
        ...
        public string SideBlack { get; set; }
        public string Milky { get; set; }
        public string CulletSize { get; set; }
        public string OpensName { get; set; }
        public string GroupName { get; set; }
        public string MemberComments { get; set; }
        public string refdata { get; set; }
    ...
    public class SpecificSearchDownloadViewModel
    {
        public string RowNum { get; set; }
        public string Stock { get; set; }
        public string Shape { get; set; }
    ...
    public class InventoryDownloadEmailViewModel
    {
        public string RowNum { get; set; }
        public string Stock { get; set; }
        public string SalesLocation { get; set; }
