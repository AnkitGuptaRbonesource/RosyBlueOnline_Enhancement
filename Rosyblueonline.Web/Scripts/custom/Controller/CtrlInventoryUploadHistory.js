        ...
        if (dtFileUpload.getDataTable() == null || dtFileUpload.getDataTable() == undefined) {
            dtFileUpload.init({
                ...
                dataTable: {
                    ...
                    ajax: {
                        type: 'Post',
                        url: '/Inventory/UploadHistoryForGrid',
                    ...
                    columnDefs: [{
                        ...
                        render: function (data, type, row) {
                            if (row.refData == "CHANGE_DISCOUNT" || row.refData == "CHANGE_RAPP") {
                                return '<a href="/Content/INV/' + row.fileId + '_backup.xlsx.xlsx' + '">Download</a>';
                            }
                            return '';
                        },
                        orderable: false
