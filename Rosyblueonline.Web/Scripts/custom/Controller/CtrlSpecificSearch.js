                    ...
                    $.each(data.Result, function (i, item) {  
                        ...
                        if (item.v360url == null || item.v360url == "") {
                            ...
                            if (item.v360url.endsWith(".mp4") == true) {
                                ...
                                Images = '<iframe  id="iframev360" src=' + item.v360url + ' width="480" height="480"  style="margin-left:65px;width: 270px;margin-left: -10px;" scrolling="no" frameborder="no" allowfullscreen=""></iframe>';
                            }
                        }

                        var newListItem =  '<div id="' + pageno + '"    class="col-md-3 col-sm-4 col-xs-6 post">' +
                            '<div class="align-centerd diamond">'+
                            '<div class="img-container pointer" ><a target="_blank" href="/DiamondSearch/DiamondView?id=' + item.inventoryID + '">' + Images +
