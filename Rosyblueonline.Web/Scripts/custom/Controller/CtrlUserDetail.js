            ...
            if (dtOrder.getDataTable() == null || dtOrder.getDataTable() == undefined) {
                dtOrder.init({
                    ...
                    dataTable: {
                        ...
                        columns: [
                            { data: "firstName", class: 'whspace'},
                            { data: "companyName", class: 'whspace'},
                            { data: "roleID", class: 'whspace' },
                            { data: "mobile", class: 'whspace' },
                            { data: "username", class: 'whspace' },
                            { data: "emailId", class: 'whspace'},
                            { data: "countryName", class: 'whspace' },
                            { data: "startSizePermitted", class: 'whspace' },
                            { data: "rowDownloadPermitted", class: 'whspace'},
